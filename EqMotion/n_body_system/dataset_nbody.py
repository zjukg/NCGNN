...
class NBodyDataset():
    ...
    def __getitem__(self, i):
        ...
        if self.training:
            return loc[:,0:frame_0], vel[:,0:frame_0], edge_attr, charges, loc[:,frame_0:frame_T], vel[:,frame_0:frame_T]
        else:
            return loc[:,0:frame_0], vel[:,0:frame_0], edge_attr, charges, loc[:,frame_0:frame_T], vel[:,frame_0:frame_T]
...
class NBodyDataset_reasoning():
    ...
    def __getitem__(self, i):
        ...
        if self.training:
            return loc[:,0:frame_0], vel[:,0:frame_0], edge_attr, edge_attr, loc[:,frame_0:frame_T], vel[:,frame_0:frame_T]
        else:
            return loc[:,0:frame_0], vel[:,0:frame_0], edge_attr, edge_attr, loc[:,frame_0:frame_T], vel[:,frame_0:frame_T]
